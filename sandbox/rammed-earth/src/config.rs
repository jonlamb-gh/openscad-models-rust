...
pub const OUTER_WINDOW_FRAME_WIDTH: f32 =
    OUTER_WALL_THICKNESS + (2.0 * OUTER_WINDOW_FRAME_OVERRUN);
...
pub const DOOR_FRAME_WIDTH: f32 =
    OUTER_WALL_THICKNESS + (2.0 * DOOR_FRAME_OVERRUN);
