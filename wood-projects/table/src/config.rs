...
pub const TENON_OVERRUN: f32 = 4.0;
...
pub const TOP_BOARD_MINOR_COUNT: usize = 3;
...
pub const TOP_SUPPORT_BOARD_INSET: f32 = TOP_BOARD_MINOR_WIDTH / 2.0;
...
pub const TENON_SIDE_SUPPORT_BOARD_LENGTH: f32 =
    LEG_TO_LEG_DIST + POST_THICKNESS + (2.0 * TENON_OVERRUN);
pub const MORTISE_SIDE_SUPPORT_BOARD_LENGTH: f32 =
    LEG_TO_LEG_DIST + POST_THICKNESS + (2.0 * MORTISE_BOARD_TENON_OVERRUN);
